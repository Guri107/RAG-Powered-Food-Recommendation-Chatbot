...
# function to load and normalize food data from the JSON file
...
# function to create a Chroma DB collection with proper embedding configuration:
...
# Function to populate the collection with food data and generate embeddings
...
# function to perform basic similarity search:
