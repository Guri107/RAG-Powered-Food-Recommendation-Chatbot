...
# main function that initializes the interactive search system
def main():
...
# main interactive loop that handles user input
...
# function that processes food searches and displays results
def handle_food_search(collection, query):
    ...
    if not results:
        ...
        print(" Try differentquery keywords like:")
...
# function that suggests related searches based on current results
